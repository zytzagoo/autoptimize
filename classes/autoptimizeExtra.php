...
class autoptimizeExtra
{
    ...
    protected function run_on_frontend()
    {
        ...
        // Async JS!
        if ( ! empty( $options['autoptimize_extra_text_field_3'] ) ) {
    ...
    public function filter_optimize_google_fonts( $in )
    {
        ...
        if ( '3' === $options['autoptimize_extra_radio_field_4'] ) {
            ...
            $fonts_markup .= '] },classes:false, events:false, timeout:1500};(function() {var wf = document.createElement(\'script\');wf.src=\'https://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js\';wf.type=\'text/javascript\';wf.defer=\'true\';var s=document.getElementsByTagName(\'script\')[0];s.parentNode.insertBefore(wf, s);})();</script>';
        }
